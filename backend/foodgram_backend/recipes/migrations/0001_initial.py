    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shoppingcart_on_user', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь, ктр добавил в список покупок')),
            ],
            options={
